...
# This is a fork of Faugus's Faugus Lancher
<a href='https://github.com/Faugus/faugus-launcher'>Original project's github page</a>
...
wget -P ~/faugus-launcher https://github.com/Faugus/faugus-launcher/releases/download/v.1.1-23/faugus-launcher_1.1-23_amd64.deb
wget -P ~/faugus-launcher https://github.com/Faugus/faugus-launcher/releases/download/v.1.1-23/python3-umu-launcher_1.1.4-1_amd64.deb
wget -P ~/faugus-launcher https://github.com/Faugus/faugus-launcher/releases/download/v.1.1-23/umu-launcher_1.1.4-1_all.deb
...
Download <a href="https://github.com/Faugus/faugus-launcher/releases/download/v.1.1-23/faugus-launcher-0.1.17.flatpak">faugus-launcher-0.1.17.flatpak</a> and run:
```
